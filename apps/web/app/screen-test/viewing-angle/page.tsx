            ...
            <Alert>
              <AlertDescription>
                ...
                <ul className="mt-2 space-y-1">
                  <li>• <strong>IPS屏幕</strong>：可视角度约178°，侧看色彩几乎不变</li>
                  <li>• <strong>VA屏幕</strong>：可视角度较窄，侧看会明显变色变暗</li>
                  <li>• <strong>TN屏幕</strong>：可视角度最差，侧看色彩失真严重</li>
                  <li>• <strong>OLED屏幕</strong>：可视角度优秀，但大角度可能偏色</li>
                </ul>
              </AlertDescription>
            </Alert>
          </CardContent>
